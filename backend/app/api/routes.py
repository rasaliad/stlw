...
from app.api.endpoints import auth, users, dispatches, goods_receipts, items, stl_pedidos, sap_delivery, sap_goods_receipt, telegram_admin, manual_dispatch, sap_sync
...
router.include_router(sap_sync.router, prefix="/sap/sync", tags=["sap-sync"])